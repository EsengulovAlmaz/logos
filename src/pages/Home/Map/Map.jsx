        ...
        <div className="map__contacts">
          ...
          <div className="map__info">
            <div className="map__info-address">
              <span>
                <svg width="18" height="21" viewBox="0 0 18 21" fill="none"
                  ...
                  <circle cx="8.91741" cy="9.53899" r="2.46087" stroke="#6D9C74" strokeWidth="1.5" strokeLinecap="round"
            ...
            <div className="map__info-address">
              ...
              <a href="" className="map__info-street" alt="">
                <span className="map__info-dot">
                  Наша почта:
                </span>
                auto.wash@gmail.com
          ...
          <div className="map__contact">
            ...
            <a href="" className="map__contact-tel" alt="">
              +7 (917) 510-57-59
          ...
          <div className="map__social">
            ...
            <a href="" className="map__social-link" alt="">
